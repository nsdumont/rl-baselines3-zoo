...
for env in "MountainCarContinuous-v0" "LunarLanderContinuous-v2"
do
    echo "Env: $env"
    for (( seed = 0 ; seed < $1 ; ++seed ))
    do
        ...
        python train.py --env $env --algo sac --seed $seed --verbose 0 --conf-file  hyperparams/ssp/sac_ssp.yml --track --wandb-project-name classiccontrol --wandb-entity nicole-s-dumont --wandb-tags $env ssp-obs
    done
done
...
do
    ...
    python train.py --env CartPole-v1 --algo ppo --seed $seed --verbose 0 --eval-freq 10 --eval-episodes 100 --stop-reward-threshold 500.0 --conf-file  hyperparams/ssp/ppo_ssp.yml --track --wandb-project-name classiccontrol --wandb-entity nicole-s-dumont --wandb-tags CartPole-v1-2 ssp-obs
done
...
do
    ...
    python train.py --env MountainCar-v0 --algo ppo --seed $seed --verbose 0 --eval-freq 10 --eval-episodes 100 --stop-reward-threshold -110.0 --conf-file  hyperparams/ssp/ppo_ssp.yml --track --wandb-project-name classiccontrol --wandb-entity nicole-s-dumont --wandb-tags MountainCar-v0-2 ssp-obs
done
...
do
    ...
    python train.py --env LunarLander-v2 --algo ppo --seed $seed --verbose 0 --eval-freq 10 --eval-episodes 100 --stop-reward-threshold 200.0 --conf-file  hyperparams/ssp/ppo_ssp.yml --track --wandb-project-name classiccontrol --wandb-entity nicole-s-dumont --wandb-tags LunarLander-v2-2 ssp-obs
done
...
do
    ...
    python train.py --env MountainCarContinuous-v0 --algo sac --seed $seed --verbose 0 --eval-freq 10 --eval-episodes 100 --stop-reward-threshold 90.0 --conf-file  hyperparams/ssp/sac_ssp.yml --track --wandb-project-name classiccontrol --wandb-entity nicole-s-dumont --wandb-tags MountainCarContinuous-v0-2 ssp-obs
done
...
do
    ...
    python train.py --env LunarLanderContinuous-v2 --algo sac --seed $seed --verbose 0 --eval-freq 10 --eval-episodes 100 --stop-reward-threshold 200.0 --conf-file  hyperparams/ssp/sac_ssp.yml --track --wandb-project-name classiccontrol --wandb-entity nicole-s-dumont --wandb-tags LunarLanderContinuous-v2 ssp-obs
done
